...
public class NetworkDelete extends AsyncTask<String,Void,String> {
    private URL Url;
    private String URL_Adress = "http://10.100.206.37:9888/WebContent/testDB3_delete.jsp";
    private Custom_Adaper adaper;

    public NetworkDelete(Custom_Adaper adapter){this.adaper=adapter;}
